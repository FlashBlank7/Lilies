...
SLICES = [
    GapSlice(
        ...
        dependency_risk=1,
        source="docs/stage-report-archives/v0.2.x/v0.2.66_e08_control_behavior_matrix.md",
    ...
    GapSlice(
        ...
        dependency_risk=4,
        source="docs/stage-report-archives/v0.2.x/v0.2.65_e08_policy_controls_surface.md",
