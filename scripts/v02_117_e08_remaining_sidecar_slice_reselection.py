...
def candidates() -> list[E08RemainingSlice]:
    return [
        ...
        E08RemainingSlice(
            ...
            testability=16,
            scope_risk=33,
            existing_evidence="docs/stage-reports/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-reports/v0.2.116_e08_workflow_run_worker_offload_handler.md",
...
def select_slice(items: list[E08RemainingSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source_stage_report": "docs/stage-reports/v0.2.116_e08_workflow_run_worker_offload_handler.md",
        "status": "completed",
