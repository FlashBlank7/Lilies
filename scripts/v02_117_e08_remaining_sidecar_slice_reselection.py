#!/usr/bin/env python3
"""Generate v0.2.117 E08 remaining sidecar slice reselection evidence."""
...
OUTPUT_NAME = "decision_v0.2.117_e08_remaining_sidecar_slice_reselection"
...
def candidates() -> list[E08RemainingSlice]:
    return [
        E08RemainingSlice(
            ...
            testability=29,
            scope_risk=18,
            existing_evidence="platform/backend/src/agent_platform/workflow_runtime.py; platform/backend/src/agent_platform/workflow_storage.py; tests/test_workflow.py",
            next_version="v0.2.118_e08_test_suite_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_118_e08_test_suite_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.118_e08_builder_build_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_118_e08_builder_build_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            slice_id="draft_patch_preview_worker_offload_handler",
            label="Worker-owned draft_patch_preview handler",
            sidecar_criticality=19,
            readiness=22,
            product_value=19,
            testability=23,
            scope_risk=15,
            existing_evidence="platform/backend/src/agent_platform/draft_patch_preview.py",
            next_version="v0.2.118_e08_draft_patch_preview_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_118_e08_draft_patch_preview_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            slice_id="benchmark_worker_offload_handler",
            label="Worker-owned benchmark handler",
            sidecar_criticality=21,
            readiness=18,
            product_value=22,
            testability=20,
            scope_risk=21,
            existing_evidence="platform/backend/src/agent_platform/builder_benchmark.py",
            next_version="v0.2.118_e08_benchmark_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_118_e08_benchmark_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            ...
            testability=16,
            scope_risk=33,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-report-archives/v0.2.x/v0.2.116_e08_workflow_run_worker_offload_handler.md",
            next_version="v0.2.118_e08_production_worker_supervision",
            first_design="docs/current-design/design_v0_2_118_e08_production_worker_supervision.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.118_e08_distributed_queue_semantics",
            first_design="docs/current-design/design_v0_2_118_e08_distributed_queue_semantics.md",
        ),
    ]
...
def select_slice(items: list[E08RemainingSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        "version": "v0.2.117",
        "decision_id": "e08_remaining_sidecar_slice_reselection_after_workflow_run_offload",
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.116_e08_workflow_run_worker_offload_handler.md",
        "status": "completed",
        ...
        "reason": (
            "v0.2.116 closed the core workflow_run worker offload path. The next highest-value concrete sidecar "
            "slice is a worker-owned test_suite handler because it extends worker ownership to validation, is highly "
            "testable with existing workflow test machinery, and is lower risk than builder_build or production "
            "supervision before more worker-owned handlers exist."
        ),
    }
...
def write_outputs(result: dict[str, Any], output_dir: Path = DEFAULT_OUTPUT_DIR) -> tuple[Path, Path]:
    ...
    lines = [
        ...
        f"- Completed workflow_run excluded: `{result['invariants']['completed_workflow_run_excluded']}`",
