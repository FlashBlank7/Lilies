#!/usr/bin/env python3
"""Generate v0.2.123 E08 remaining sidecar slice reselection evidence."""
...
OUTPUT_NAME = "decision_v0.2.123_e08_remaining_sidecar_slice_reselection"
...
def candidates() -> list[E08RemainingSlice]:
    return [
        E08RemainingSlice(
            ...
            next_version="v0.2.124_e08_builder_build_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_124_e08_builder_build_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            slice_id="production_worker_supervision",
            label="Production worker supervision",
            sidecar_criticality=35,
            readiness=24,
            product_value=32,
            testability=20,
            scope_risk=31,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-report-archives/v0.2.x/v0.2.122_e08_benchmark_worker_offload_handler.md",
            next_version="v0.2.124_e08_production_worker_supervision",
            first_design="docs/current-design/design_v0_2_124_e08_production_worker_supervision.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.124_e08_distributed_queue_semantics",
            first_design="docs/current-design/design_v0_2_124_e08_distributed_queue_semantics.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.124_e08_external_kms_provider_integration",
            first_design="docs/current-design/design_v0_2_124_e08_external_kms_provider_integration.md",
        ),
    ]
...
def select_slice(items: list[E08RemainingSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        "version": "v0.2.123",
        "decision_id": "e08_remaining_sidecar_slice_reselection_after_benchmark_offload",
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.122_e08_benchmark_worker_offload_handler.md",
        "status": "completed",
        ...
        "invariants": {
            "completed_benchmark_excluded": "benchmark_worker_offload_handler" in completed_ids
            and selected.slice_id != "benchmark_worker_offload_handler",
        ...
        "reason": (
            "v0.2.122 closed the benchmark worker offload path. The next highest-value concrete sidecar slice is "
            "the worker-owned builder_build handler because it is the final required worker task kind still marked "
            "unavailable; closing it should precede production worker supervision and distributed queue semantics."
        ),
    }
...
def write_outputs(result: dict[str, Any], output_dir: Path = DEFAULT_OUTPUT_DIR) -> tuple[Path, Path]:
    ...
    lines = [
        ...
        f"- Completed benchmark excluded: `{result['invariants']['completed_benchmark_excluded']}`",
