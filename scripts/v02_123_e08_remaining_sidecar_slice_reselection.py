...
def candidates() -> list[E08RemainingSlice]:
    return [
        ...
        E08RemainingSlice(
            ...
            testability=20,
            scope_risk=31,
            existing_evidence="docs/stage-reports/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-reports/v0.2.122_e08_benchmark_worker_offload_handler.md",
...
def select_slice(items: list[E08RemainingSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source_stage_report": "docs/stage-reports/v0.2.122_e08_benchmark_worker_offload_handler.md",
        "status": "completed",
