...
DEFAULT_OUTPUT = ROOT / ".tmp" / "historical-evidence" / "v0.3.18" / "application_list_search_sort_v0.3.18.json"
...
BUG_LEDGER = (
    ...
    },
    {
        ...
        "fix": "Update `docs/testing/historical/v0.3.55_regression_lanes.json` with v0.3.18 and expected 88 passing tests.",
