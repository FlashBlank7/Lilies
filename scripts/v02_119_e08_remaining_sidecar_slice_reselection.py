#!/usr/bin/env python3
"""Generate v0.2.119 E08 remaining sidecar slice reselection evidence."""
...
OUTPUT_NAME = "decision_v0.2.119_e08_remaining_sidecar_slice_reselection"
...
def candidates() -> list[E08RemainingSlice]:
    return [
        E08RemainingSlice(
            ...
            sidecar_criticality=22,
            readiness=25,
            product_value=22,
            testability=25,
            scope_risk=15,
            existing_evidence="platform/backend/src/agent_platform/draft_patch_preview.py; platform/backend/src/agent_platform/api.py",
            next_version="v0.2.120_e08_draft_patch_preview_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_120_e08_draft_patch_preview_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.120_e08_benchmark_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_120_e08_benchmark_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.120_e08_builder_build_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_120_e08_builder_build_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            slice_id="production_worker_supervision",
            label="Production worker supervision",
            sidecar_criticality=33,
            readiness=15,
            product_value=30,
            testability=17,
            scope_risk=32,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-report-archives/v0.2.x/v0.2.118_e08_test_suite_worker_offload_handler.md",
            next_version="v0.2.120_e08_production_worker_supervision",
            first_design="docs/current-design/design_v0_2_120_e08_production_worker_supervision.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.120_e08_distributed_queue_semantics",
            first_design="docs/current-design/design_v0_2_120_e08_distributed_queue_semantics.md",
        ),
    ]
...
def select_slice(items: list[E08RemainingSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        "version": "v0.2.119",
        "decision_id": "e08_remaining_sidecar_slice_reselection_after_test_suite_offload",
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.118_e08_test_suite_worker_offload_handler.md",
        "status": "completed",
        ...
        "reason": (
            "v0.2.118 closed the test_suite worker offload path. The next highest-value concrete sidecar slice is "
            "a worker-owned draft_patch_preview handler because it expands handler coverage with a small, API-backed, "
            "highly testable path before the higher-risk builder_build and production-supervision slices."
        ),
    }
...
def write_outputs(result: dict[str, Any], output_dir: Path = DEFAULT_OUTPUT_DIR) -> tuple[Path, Path]:
    ...
    lines = [
        ...
        f"- Completed test_suite excluded: `{result['invariants']['completed_test_suite_excluded']}`",
