...
def candidates() -> list[DispositionCandidate]:
    return [
        ...
        DispositionCandidate(
            ...
            evidence=[
                "docs/stage-report-archives/v0.2.x/v0.2.100_e08_operator_runbook_lifecycle.md",
            ],
...
def select_disposition(items: list[DispositionCandidate] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.100_e08_operator_runbook_lifecycle.md",
        "status": "completed",
