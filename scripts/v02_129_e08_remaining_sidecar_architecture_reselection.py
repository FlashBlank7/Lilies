...
def candidates() -> list[E08RemainingArchitectureSlice]:
    return [
        E08RemainingArchitectureSlice(
            ...
            testability=20,
            scope_risk=34,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.126_e08_production_worker_supervision.md; docs/stage-report-archives/v0.2.x/v0.2.128_e08_distributed_queue_semantics.md; platform/backend/src/agent_platform/worker_runner.py",
...
def select_slice(items: list[E08RemainingArchitectureSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.128_e08_distributed_queue_semantics.md",
        "status": "completed",
