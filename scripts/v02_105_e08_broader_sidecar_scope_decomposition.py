...
def candidates() -> list[E08GapCandidate]:
    return [
        E08GapCandidate(
            ...
            testability=30,
            scope_risk=14,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.22_platform_harness_stdio_sandbox_egress.md; docs/stage-report-archives/v0.2.x/v0.2.24_platform_harness_stdio_policy_controls.md",
        ...
        E08GapCandidate(
            ...
            testability=20,
            scope_risk=24,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.15_platform_harness_secret_policy.md; docs/stage-report-archives/v0.2.x/v0.2.25_platform_harness_secret_envelope.md",
...
def decompose(items: list[E08GapCandidate] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.104_productization_lane_reselection.md",
        "status": "completed",
