...
DEFAULT_OUTPUT = ROOT / ".tmp" / "historical-evidence" / "v0.3.23" / "customer_scenario_selection_v0.3.23.json"
...
BUG_LEDGER = (
    ...
    },
    {
        ...
        "fix": "Update `docs/testing/historical/v0.3.55_regression_lanes.json` with v0.3.23 and expected 118 passing tests.",
