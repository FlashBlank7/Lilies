...
DEFAULT_OUTPUT = ROOT / ".tmp" / "historical-evidence" / "v0.3.25" / "create_action_state_v0.3.25.json"
...
def source_marker_checks() -> list[dict[str, Any]]:
    checks = [
        ...
        ("regression_manifest_updated", "docs/testing/historical/v0.3.55_regression_lanes.json", ("tests/test_v03_25_create_action_state.py", "v0.3.x_current_release_gate")),
    ]
