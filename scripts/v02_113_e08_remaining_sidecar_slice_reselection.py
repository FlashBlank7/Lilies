...
def candidates() -> list[E08RemainingSlice]:
    return [
        E08RemainingSlice(
            ...
            testability=25,
            scope_risk=18,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.110_e08_complete_handler_catalog.md; docs/stage-report-archives/v0.2.x/v0.2.112_e08_distributed_heartbeat_registry.md",
...
def select_slice(items: list[E08RemainingSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.112_e08_distributed_heartbeat_registry.md",
        "status": "completed",
