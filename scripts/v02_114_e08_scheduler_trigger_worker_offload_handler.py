...
def verify_contract() -> dict[str, Any]:
    ...
    checks = {
        ...
        == {"workflow_run", "builder_build", "test_suite", "benchmark", "draft_patch_preview"},
    ...
    return {
        ...
        "source_stage_report": "docs/stage-reports/v0.2.113_e08_remaining_sidecar_slice_reselection.md",
