#!/usr/bin/env python3
"""Generate v0.2.109 E08 remaining sidecar slice reselection evidence."""
...
OUTPUT_NAME = "decision_v0.2.109_e08_remaining_sidecar_slice_reselection"
...
def candidates() -> list[E08RemainingSlice]:
    return [
        E08RemainingSlice(
            ...
            label="Complete Platform Harness worker handler catalog",
            sidecar_criticality=30,
            readiness=22,
            product_value=27,
            testability=25,
            scope_risk=17,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.27_worker_runner_cli_and_handler.md",
            next_version="v0.2.110_e08_complete_handler_catalog",
            first_design="docs/current-design/design_v0_2_110_e08_complete_handler_catalog.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.110_e08_distributed_heartbeat_registry",
            first_design="docs/current-design/design_v0_2_110_e08_distributed_heartbeat_registry.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.110_e08_external_kms_provider_integration",
            first_design="docs/current-design/design_v0_2_110_e08_external_kms_provider_integration.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.110_e08_long_running_sidecar_operations_runbook",
            first_design="docs/current-design/design_v0_2_110_e08_long_running_sidecar_operations_runbook.md",
        ),
    ]
...
def select_slice(items: list[E08RemainingSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        "version": "v0.2.109",
        "decision_id": "e08_remaining_sidecar_slice_reselection_after_secret_rotation",
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.108_e08_secret_kms_rotation_contract.md",
        "status": "completed",
        ...
        "reason": (
            "v0.2.108 closed the local secret rotation envelope slice. Among remaining open E08 sidecar gaps, "
            "the complete handler catalog is the highest-value next slice because worker-handler coverage is "
            "sidecar-critical, implementation-ready from v0.2.27 evidence, and testable without claiming full sidecar completion."
        ),
    }
...
def write_outputs(result: dict[str, Any], output_dir: Path = DEFAULT_OUTPUT_DIR) -> tuple[Path, Path]:
    ...
    lines = [
        ...
        f"- Completed secret slice excluded: `{result['invariants']['completed_secret_slice_excluded']}`",
