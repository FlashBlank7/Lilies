#!/usr/bin/env python3
"""Generate v0.2.127 E08 remaining sidecar architecture reselection evidence."""
...
OUTPUT_NAME = "decision_v0.2.127_e08_remaining_sidecar_architecture_reselection"
...
def candidates() -> list[E08RemainingArchitectureSlice]:
    return [
        E08RemainingArchitectureSlice(
            ...
            sidecar_criticality=39,
            readiness=23,
            product_value=35,
            testability=22,
            scope_risk=34,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-report-archives/v0.2.x/v0.2.126_e08_production_worker_supervision.md; platform/backend/src/agent_platform/platform_harness.py",
            next_version="v0.2.128_e08_distributed_queue_semantics",
            first_design="docs/current-design/design_v0_2_128_e08_distributed_queue_semantics.md",
        ),
        E08RemainingArchitectureSlice(
            ...
            testability=16,
            scope_risk=36,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.126_e08_production_worker_supervision.md; platform/backend/src/agent_platform/worker_runner.py",
            next_version="v0.2.128_e08_external_process_manager",
            first_design="docs/current-design/design_v0_2_128_e08_external_process_manager.md",
        ),
        E08RemainingArchitectureSlice(
            ...
            testability=16,
            scope_risk=31,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.108_e08_secret_kms_rotation_contract.md; platform/backend/src/agent_platform/platform_harness.py",
            next_version="v0.2.128_e08_external_kms_provider_integration",
            first_design="docs/current-design/design_v0_2_128_e08_external_kms_provider_integration.md",
        ),
    ]
...
def select_slice(items: list[E08RemainingArchitectureSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        "version": "v0.2.127",
        "decision_id": "e08_remaining_sidecar_architecture_reselection_after_production_worker_supervision",
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.126_e08_production_worker_supervision.md",
        "status": "completed",
        ...
        "reason": (
            "v0.2.126 closed in-process production worker supervision. The next highest-value remaining "
            "architecture slice is distributed queue semantics because supervised workers and durable heartbeat "
            "evidence now exist, but the task store still lacks explicit queue ownership/requeue semantics. "
            "External process management and external KMS remain important but less ready follow-up slices."
        ),
    }
