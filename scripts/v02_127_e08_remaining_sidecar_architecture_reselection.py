...
def candidates() -> list[E08RemainingArchitectureSlice]:
    return [
        E08RemainingArchitectureSlice(
            ...
            testability=22,
            scope_risk=34,
            existing_evidence="docs/stage-reports/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-reports/v0.2.126_e08_production_worker_supervision.md; platform/backend/src/agent_platform/platform_harness.py",
        ...
        E08RemainingArchitectureSlice(
            ...
            testability=16,
            scope_risk=36,
            existing_evidence="docs/stage-reports/v0.2.126_e08_production_worker_supervision.md; platform/backend/src/agent_platform/worker_runner.py",
...
def select_slice(items: list[E08RemainingArchitectureSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source_stage_report": "docs/stage-reports/v0.2.126_e08_production_worker_supervision.md",
        "status": "completed",
