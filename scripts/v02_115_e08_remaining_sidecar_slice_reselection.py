...
def candidates() -> list[E08RemainingSlice]:
    return [
        E08RemainingSlice(
            ...
            testability=25,
            scope_risk=23,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.114_e08_scheduler_trigger_worker_offload_handler.md; platform/backend/src/agent_platform/workflow_runtime.py",
        ...
        E08RemainingSlice(
            ...
            testability=15,
            scope_risk=33,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-report-archives/v0.2.x/v0.2.114_e08_scheduler_trigger_worker_offload_handler.md",
...
def select_slice(items: list[E08RemainingSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.114_e08_scheduler_trigger_worker_offload_handler.md",
        "status": "completed",
