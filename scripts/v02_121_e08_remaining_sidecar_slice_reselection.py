#!/usr/bin/env python3
"""Generate v0.2.121 E08 remaining sidecar slice reselection evidence."""
...
OUTPUT_NAME = "decision_v0.2.121_e08_remaining_sidecar_slice_reselection"
...
def candidates() -> list[E08RemainingSlice]:
    return [
        E08RemainingSlice(
            ...
            testability=25,
            scope_risk=14,
            existing_evidence="platform/backend/src/agent_platform/builder_benchmark.py; platform/backend/src/agent_platform/api.py",
            next_version="v0.2.122_e08_benchmark_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_122_e08_benchmark_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            ...
            next_version="v0.2.122_e08_builder_build_worker_offload_handler",
            first_design="docs/current-design/design_v0_2_122_e08_builder_build_worker_offload_handler.md",
        ),
        E08RemainingSlice(
            ...
            testability=18,
            scope_risk=31,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-report-archives/v0.2.x/v0.2.120_e08_draft_patch_preview_worker_offload_handler.md",
            next_version="v0.2.122_e08_production_worker_supervision",
            first_design="docs/current-design/design_v0_2_122_e08_production_worker_supervision.md",
        ),
        E08RemainingSlice(
            ...
            testability=16,
            scope_risk=34,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.112_e08_distributed_heartbeat_registry.md",
            next_version="v0.2.122_e08_distributed_queue_semantics",
            first_design="docs/current-design/design_v0_2_122_e08_distributed_queue_semantics.md",
        ),
        E08RemainingSlice(
            ...
            testability=15,
            scope_risk=30,
            existing_evidence="docs/stage-report-archives/v0.2.x/v0.2.108_e08_secret_kms_rotation_contract.md",
            next_version="v0.2.122_e08_external_kms_provider_integration",
            first_design="docs/current-design/design_v0_2_122_e08_external_kms_provider_integration.md",
        ),
    ]
...
def select_slice(items: list[E08RemainingSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        "version": "v0.2.121",
        "decision_id": "e08_remaining_sidecar_slice_reselection_after_draft_patch_preview_offload",
        "source_stage_report": "docs/stage-report-archives/v0.2.x/v0.2.120_e08_draft_patch_preview_worker_offload_handler.md",
        "status": "completed",
        ...
        "invariants": {
            "completed_draft_patch_preview_excluded": "draft_patch_preview_worker_offload_handler" in completed_ids
            and selected.slice_id != "draft_patch_preview_worker_offload_handler",
            "completed_test_suite_excluded": "test_suite_worker_offload_handler" in completed_ids
            and selected.slice_id != "test_suite_worker_offload_handler",
            "completed_workflow_run_excluded": "workflow_run_worker_offload_handler" in completed_ids
            and selected.slice_id != "workflow_run_worker_offload_handler",
        ...
        "reason": (
            "v0.2.120 closed the draft_patch_preview worker offload path. The next highest-value concrete "
            "sidecar slice is a worker-owned benchmark handler because benchmark evaluation is deterministic, "
            "already has API and Platform Harness task semantics, and can close another required worker kind "
            "before the higher-risk builder_build lifecycle and production-supervision slices."
        ),
    }
...
def write_outputs(result: dict[str, Any], output_dir: Path = DEFAULT_OUTPUT_DIR) -> tuple[Path, Path]:
    ...
    lines = [
        "# v0.2.121 E08 remaining sidecar slice reselection",
        "",
        ...
        f"- Completed draft_patch_preview excluded: `{result['invariants']['completed_draft_patch_preview_excluded']}`",
