...
def candidates() -> list[E08RemainingArchitectureSlice]:
    return [
        E08RemainingArchitectureSlice(
            ...
            testability=22,
            scope_risk=28,
            existing_evidence="docs/stage-reports/v0.2.112_e08_distributed_heartbeat_registry.md; docs/stage-reports/v0.2.124_e08_builder_build_worker_offload_handler.md",
        ...
        E08RemainingArchitectureSlice(
            ...
            testability=17,
            scope_risk=35,
            existing_evidence="docs/stage-reports/v0.2.112_e08_distributed_heartbeat_registry.md; platform/backend/src/agent_platform/harness.py",
        ...
        E08RemainingArchitectureSlice(
            ...
            testability=16,
            scope_risk=31,
            existing_evidence="docs/stage-reports/v0.2.108_e08_secret_kms_rotation_contract.md; platform/backend/src/agent_platform/harness.py",
...
def select_slice(items: list[E08RemainingArchitectureSlice] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source_stage_report": "docs/stage-reports/v0.2.124_e08_builder_build_worker_offload_handler.md",
        "status": "completed",
