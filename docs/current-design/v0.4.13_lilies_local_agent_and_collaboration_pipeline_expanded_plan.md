...
| 字段 | 内容 |
| --- | --- |
| 来源意图 | `LILIES-I002` 至 `I016`、`LILIES-I020`、`LILIES-I021`、`PRODUCT-015`、`PRODUCT-016`、`PRODUCT-017` |
| 依赖 | T01G |
| 具体改动 | 冻结 EXP-LILIES-001 题包；真实启动；按本题 manual 或 autonomous 策略处理证据完整的通用能力报告；持续同一 Builder 上下文重试；Provider 默认断路且真实 run 需要单次显式放行，runner 持久记录按阶段 Token/成本快照 |
