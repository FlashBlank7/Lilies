# Lilies 新特性使用报告（2026-08历史记录）

本文件保留当时的截图与行为记录，不是v0.6当前使用指南。生成、运行、审批和训练入口已调整，当前操作与验证范围见[原型说明](RELEASE-v0.6-prototype.md)和[当前执行路径](V06_HARNESS_CURRENT_REVIEW.md)。
