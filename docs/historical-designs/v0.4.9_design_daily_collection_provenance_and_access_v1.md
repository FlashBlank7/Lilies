...
Implemented and verified with the editable four-block scenario, allowlist and robots enforcement, timeout/size/source limits, canonical URL and content-hash dedupe, per-source checkpoint/resume, durable provenance receipts, deterministic Markdown digest, H1/H3 evaluation, and explicit blocked H4/external-notification claims.
