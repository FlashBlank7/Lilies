...
| --- | --- | --- | --- |
| Platform Harness monitor UI | `docs/current-design/design_platform_harness_observability_ui_v1.md` | implemented | Studio can inspect task monitor records without mutating workflows. |
