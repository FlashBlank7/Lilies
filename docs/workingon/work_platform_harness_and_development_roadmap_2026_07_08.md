...
| Order | Design | Status |
| --- | --- | --- |
| 1 | `docs/current-design/design_platform_harness_task_monitor_v1.md` | implemented |
| 2 | `docs/current-design/design_builder_benchmark_v1.md` | implemented |
| 3 | `docs/current-design/design_natural_language_draft_patch_preview.md` | implemented |
