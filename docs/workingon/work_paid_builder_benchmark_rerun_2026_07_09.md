...
- `docs/current-design/design_paid_builder_benchmark_rerun_v1.md`

## Acceptance Criteria

- The rerun writes to `docs/workingon/experiment_builder_test_self_consistency_rerun_2026_07_09.json`.
...
- Generated DOCX report at `docs/workingon/experiment-reports/2026-07-09_builder_test_self_consistency_rerun.docx`.
...
unzip -t docs/workingon/experiment-reports/2026-07-09_builder_test_self_consistency_rerun.docx
```
