...
Status: completed and archived at the revision-2 evidence floor
...
- Evidence: `docs/workingon-archives/v0.4.3/v0.4.3_browser_fixture.json` and `docs/workingon-archives/v0.4.3/v0.4.3_browser_verification.json`.
