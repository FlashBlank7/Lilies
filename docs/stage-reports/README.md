...
- Latest completed version: `v0.3.17_application_list_status_filters`.
- Next planned version: `v0.3.18_application_list_search_sort`.
- Current target: add search and predictable sorting to long application lists.
