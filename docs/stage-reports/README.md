...
- Latest completed version: `v0.3.7_draft_detail_first_run_guidance`.
- Next planned version: `v0.3.8_runtime_connection_status_surface`.
- Current target: replace static frontend connection status with health-derived runtime/auth state so non-technical users are not misled.
